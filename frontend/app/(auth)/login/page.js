    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="hidden lg:flex w-1/2 bg-indigo-600 items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
          ...
          <div className="absolute top-[20%] right-[-10%] w-96 h-96 bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
        ...
        <div className="relative z-10 text-white p-12 flex flex-col items-start max-w-lg">
          ...
          <h1 className="text-5xl font-extrabold tracking-tight mb-6 leading-tight">
            Chào mừng trở lại PhoneStore
          </h1>
          <p className="text-lg text-indigo-100 font-medium">
            Khám phá những mẫu điện thoại mới nhất cùng hàng ngàn ưu đãi hấp dẫn dành riêng cho bạn.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="text-slate-500 font-medium">Vui lòng nhập thông tin để tiếp tục</p>
          </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-slate-50 text-slate-500 font-medium">Hoặc tiếp tục với</span>
              </div>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-slate-500 font-medium">
            Chưa có tài khoản?{' '}
            <Link href="/register" className="font-bold text-indigo-600 hover:text-indigo-500 hover:underline underline-offset-4 transition-all">
              Đăng ký ngay
            </Link>
          </p>
        </div>
